    ...
    <div class="card-body pt-4">
        ...
        <div class="d-flex justify-content-center">
            <a class="me-3" href="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard"
                target="_blank">
                <img src="<?php echo _WEB_ROOT?>/app/view/assets/img/technologies/bootstrap-5-logo.svg" class="image image-xs">
            </a>
            <a href="https://demo.themesberg.com/volt-react-dashboard/#/" target="_blank">
                <img src="<?php echo _WEB_ROOT?>/app/view/assets/img/technologies/react-logo.svg" class="image image-xs">
            </a>
            <a href="https://appseed.us/admin-dashboards/flask-dashboard-volt" target="_blank">
                <img src="<?php echo _WEB_ROOT?>/app/view/assets/img/technologies/flask-logo.svg" class="image image-xs">
            </a>
            <a href="https://appseed.us/admin-dashboards/django-dashboard-volt" target="_blank">
                <img src="<?php echo _WEB_ROOT?>/app/view/assets/img/technologies/django-logo.svg" class="image image-xs">
            </a>                        
        </div>
    </div>
</div>
